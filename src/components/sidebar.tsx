...
import { ChartPie, SquareChartGantt, UserRoundCog, User2 } from "lucide-react";
          ...
          <ul>
            ...
            <li className="hover:bg-gray-100 rounded ">
              <Link
                ...
                href="/admin"
              >
                <User2 className="text-gray-500 transition-colors duration-[75ms] m-2 hover:text-gray-950 " />
                {"admin"}
              </Link>
            </li>
          </ul>
